...
<blockquote class="blockquote">
  <p class="mb-0">Welcome for Transfer.</p>
</blockquote>
<div class="form-group">
	<form:form class="needs-validation" onsubmit="return validLogin();" novalidate id="Transfer" modelAttribute="transaction" action="${pageContext.request.contextPath}/TransferProcess/${cid}"  method="post">
		<table>
			<tr>	
			...
			<tr>	
				<td><form:label path="account_number_target">Recipient Account Number :</form:label></td>
				<td><form:input path="account_number_target" name="account_number_target"
						id="validationCustom05" class="form-control" type="text" /></td>
			</tr>
			<tr>
        ...
        Please provide a valid Amount.
			...
			<tr>
				<td></td>
				<td align="left">
				<form:button id="validationCustom05" name="Deposit" class="btn btn-success" type="submit">NEFT-Transfer</form:button>
